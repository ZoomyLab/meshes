...
/* scale = 0.125; */
/* scale = 0.0625; */
scale = 0.03125 / size_factor;

transfinite_scale = 10 * size_factor;
...
Physical Curve("inflow", 50000) = {1009};
Physical Curve("wall", 50001) = {19, 119, 12, 23, 123, 34, 45, 145, 56, 67, 167, 78, 312, 323, 334, 345, 356, 367, 378, 223, 245, 267, 1011, 1012, 1013, 1014, 1015, 1016, 1017, 1018, 1021, 1028, 1008};
Physical Surface("surface", 60000) = {20001, 20002, 20003, 20004, 20005, 20006, 20007, 20008, 20009, 20010, 20011, 20012, 20013, 20014, 20015, 20016, 20017, 20018, 20019};
