...
Point(1) = {0, 0, 0, cl};
Point(2) = {0, width, 0, cl};
Point(3) = {length, width, 0, cl};
Point(4) = {length, 0, 0, cl};
...
Point(5) = {x_hole-d_hole  , y_hole-d_hole, 0, cl};
Point(6) = {x_hole-d_hole  , y_hole+d_hole, 0, cl};
Point(7) = {x_hole+d_hole  , y_hole+d_hole, 0, cl};
Point(8) = {x_hole+d_hole  , y_hole-d_hole, 0, cl};
Point(9) = {x_hole         , y_hole, 0, cl};
